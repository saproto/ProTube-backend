<template>
  <div>
    <div class="bg-proto_green  md:flex shadow md:rounded-sm"> <!-- dark:bg-true_gray-700 -->
      <div class="px-4 md:flex-1 py-5 sm:p-6">
      ...
      <div class=" flex-shrink-0 mr-6 my-auto">
          ...
          <img class="w-30 h-0 md:h-36 object-cover flex-shrink-0 mx-auto" src="logo_classic.png" />
      </div>
    </div>
  </div>
</template>
