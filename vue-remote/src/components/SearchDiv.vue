      ...
      <div class="px-4 py-5 sm:p-6">
        ...
        <form @submit="fetchVideos" onsubmit="return false" class="mt-5 flex lg:w-2/4 sm:items-center">
          <div class="w-full group md:max-w-md">
            <input minlength="1" v-model="search_string" class="bg-transparent outline-none w-full pl-2 border-b border-custom_blue2" placeholder="Title, author etc of any song"/>
          </div>
