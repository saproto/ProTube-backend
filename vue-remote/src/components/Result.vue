    ...
    <div>
      <div class="-mt-px group flex divide-x divide-gray-200">
        <div class="w-0 flex-1 flex">
          <button :disabled="(videoStatusCode === 0)" @click="addVideoToQueue()" :class="generateClasses" class="hidden group relative -mr-px w-0 flex-1 inline-flex items-center justify-center py-2 text-sm font-medium rounded-br-sm ">
...
const viewsFormatted = computed(() => {
  const views =  props.video.viewCount;
